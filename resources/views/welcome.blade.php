...
-->
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets1/css/fontawesome.css') }}" />
    <link rel="stylesheet" href="{{ URL::asset('assets1/css/templatemo-style.css') }}" />
    <link rel="stylesheet" href="{{ URL::asset('assets1/css/owl.css') }}" />
  ...
  <body>
    <div id="page-wraper">
      ...
      <div class="responsive-nav">
        ...
        <div id="menu" class="menu" style="background-color: #2F323A">
          <i class="fa fa-times" id="menu-close"></i>
          <div class="container">
            <div class="image">
              <a href="#"><img src="{{ URL::asset('assets1/images/handinhand.png') }}" alt="" /></a>
            </div>
            <div class="author-content">
              <a href="/joinus" class="btn btn-info" role="button">JOIN US</a>
            ...
            <nav class="main-nav" role="navigation">
              <ul class="main-menu">
                ...
                <li><a href="#section3">Our community</a></li>
      ...
      <section class="section about-me" data-section="section1">
        ...
        @endif
          <div class="section-heading">
            ...
            <span
              >We are tryibg to make a better world by helping each other. A great community building in mass number now dreaming of a happy world
          </div>
          <div class="left-image-post">
            <div class="row">
              <div class="col-md-6">
                <div class="left-image">
                  <img src="{{ URL::asset('assets1/images/social.jpg') }}" alt="" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="right-text">
                  ...
                  <p>
                    We often search for helps to different people but we dont know which person should we communicate to serve our demand or goal. We often dont know who might help us, who might not. There where we came up with the idea to help each other through hand in hand and being a known person in the community
                  </p>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="right-image">
                  <img src="{{ URL::asset('assets1/images/right-image.jpg') }}" alt="" />
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="isotope-box">
                <div class="isotope-item" data-type="nature">
                  <figure class="snip1321">
                    <img
                      src="{{ URL::asset('assets1/images/portfolio-01.jpg') }}"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="{{ URL::asset('assets1/images/portfolio-01.jpg') }}"
                ...
                <div class="isotope-item" data-type="people">
                  <figure class="snip1321">
                    <img
                      src="{{ URL::asset('assets1/images/portfolio-02.jpg') }}"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="{{ URL::asset('assets1/images/portfolio-02.jpg') }}"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
                ...
                <div class="isotope-item" data-type="animals">
                  <figure class="snip1321">
                    <img
                      src="{{ URL::asset('assets1/images/portfolio-03.jpg') }}"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="{{ URL::asset('assets1/images/portfolio-03.jpg') }}"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
                ...
                <div class="isotope-item" data-type="people">
                  <figure class="snip1321">
                    <img
                      src="{{ URL::asset('assets1/images/portfolio-04.jpg') }}"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="{{ URL::asset('assets1/images/portfolio-04.jpg') }}"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
                ...
                <div class="isotope-item" data-type="nature">
                  <figure class="snip1321">
                    <img
                      src="{{ URL::asset('assets1/images/portfolio-05.jpg') }}"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="{{ URL::asset('assets1/images/portfolio-05.jpg') }}"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
                ...
                <div class="isotope-item" data-type="animals">
                  <figure class="snip1321">
                    <img
                      src="{{ URL::asset('assets1/images/portfolio-06.jpg') }}"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="{{ URL::asset('assets1/images/portfolio-06.jpg') }}"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
    ...
    <script src="{{ URL::asset('assets1/js/isotope.min.js') }}"></script>
