            ...
            <div class="row content-panel">
              ...
              <div class="col-md-4 centered">
                <div class="profile-pic">
                  <p><img src="{{ URL::asset('img/'.Auth::user()->photo ) }}" style="height: 128px; width: 128px;" class="img-circle"></p>
                  <p>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 detailed">
                        ...
                        <div class="col-md-8 col-md-offset-2 mt">
                          ...
                          <br>
                          <p>
                            Headquarters<br/>{{ Auth::user()->address }}<br/>
                          </p>
                        </div>
                        <h4>Contacts</h4>
                        <div class="col-md-8 col-md-offset-2 mt">
                          ...
                          <br>
                          <p>
                            Email: {{ Auth::user()->email }}<br/> Skype: {{ Auth::user()->skype }}<br/> Website: http://Alvarez.is
                          </p>
                        </div>
                      </div>
                      <!-- /col-md-6 -->
                  ...
                  <div id="edit" class="tab-pane">
                    <div class="row">
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                        ...
                        <form role="form" method="POST" action="/user/update/{{ Auth::user()->id }}" class="form-horizontal" enctype="multipart/form-data">
                              {{ method_field('PATCH') }}
                              {{ csrf_field() }}
                          ...
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Select Your preferd area of skills</label>
                            <div class="col-lg-6">
                            <select name="prefered_area" id="prefered_area" class="form-control" data-dependent="state">
                              <option value="">Select one</option>
                              @foreach($category as $cat)
                              <option value="{{ $cat->id}}" <?php if(Auth::user()->prefered_area)echo $cat->id==Auth::user()->prefered_area? 'selected="selected"':0;?> >{{ $cat->name }}</option>
                              @endforeach
                            </select>
                            </div>    
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" name="address" value="{{ Auth::user()->address }}" id="lives-in" class="form-control">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Description</label>
                            <div class="col-lg-10">
                              <textarea rows="10" cols="30" class="form-control" id="" name="description">{{ Auth::user()->description }}</textarea>
                            </div>
                          </div>
                          <div class="form-group">
                        ...
                        <h4 class="mb">Contact Information</h4>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" name="mobile" value="{{ Auth::user()->mobile }}" placeholder=" " id="phone" class="form-control">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" name="email" value="{{ Auth::user()->email }}" placeholder=" " id="email" class="form-control" readonly="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Skype</label>
                            <div class="col-lg-6">
                              <input type="text" name="skype" value="{{ Auth::user()->skype }}" placeholder=" " id="skype" class="form-control">
                            </div>
                          </div>
